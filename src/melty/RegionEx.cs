namespace MeltySynth {
  ...
  internal static class RegionEx {
    public static void Start(this Oscillator oscillator, short[] data, InstrumentRegion region) => Start(oscillator, data, new RegionPair(PresetRegion.Default, region));
    ...
    public static void Start(this VolumeEnvelope envelope, InstrumentRegion region, int key, int velocity) => Start(envelope, new RegionPair(PresetRegion.Default, region), key, velocity);
    ...
    public static void Start(this ModulationEnvelope envelope, InstrumentRegion region, int key, int velocity) => Start(envelope, new RegionPair(PresetRegion.Default, region), key, velocity);
    ...
    public static void StartVibrato(this Lfo lfo, InstrumentRegion region, int key, int velocity) => StartVibrato(lfo, new RegionPair(PresetRegion.Default, region), key, velocity);
    ...
    public static void StartModulation(this Lfo lfo, InstrumentRegion region, int key, int velocity) => StartModulation(lfo, new RegionPair(PresetRegion.Default, region), key, velocity);
